...
export default function OnboardingPage() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 0:
        return (
          <StepOne selectedOptions={selectedOptions} onOptionSelect={handleOptionSelect} onNextStep={handleNextStep} />
        )
      case 1:
        return (
          <StepTwo selectedOptions={selectedOptions} onOptionSelect={handleOptionSelect} onNextStep={handleNextStep} />
        )
      case 2:
        return (
          <StepThree selectedOptions={selectedOptions} onOptionSelect={handleOptionSelect} onNextStep={handleNextStep} />
        )
      case 3:
        return (
          <StepFour selectedOptions={selectedOptions} onOptionSelect={handleOptionSelect} onNextStep={handleNextStep} />
        )
      default:
        return (
          <StepOne selectedOptions={selectedOptions} onOptionSelect={handleOptionSelect} onNextStep={handleNextStep} />
