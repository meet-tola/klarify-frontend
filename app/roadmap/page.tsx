...
export default function RoadmapPage() {
  ...
  return (
    <div className="container py-8 space-y-8 mt-6 md:mt-0 px-6">
        ...
        <>
          ...
          <div className="bg-white rounded-lg border p-8 text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 mb-8 max-w-xl mx-auto">
              To generate a personalized learning roadmap, you'll need to select
              a skill or take our career assessment test to discover what might
