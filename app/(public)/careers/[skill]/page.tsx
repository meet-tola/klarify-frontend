      ...
      <main className="flex-1 flex items-center justify-center">
        <section className="container flex flex-col items-center text-center max-w-3xl py-16 px-6">
          ...
          <p className="max-w-[600px] text-muted-foreground md:text-xl mb-12">
            We're currently building this section to help you navigate your
            career journey with confidence. Detailed career insights,
            personalized learning paths, and expert guidance coming soon.
          </p>
